      ...
      <div className="main-footer-container">
        <section className="main-footer-content">
          ...
          <div className="main-footer-content-dev">
            ...
            <a href="https://github.com/NicoleTeisen" target="_blank" rel="githubNicole">
              <h1> Nicole Teisen </h1>
            </a>
          </div>
          <div className="main-footer-content-dev">
            ...
            <a href="https://github.com/thayscosta3" target="_blank" rel="githubThays">
              <h1> Thays Costa </h1>
            </a>
          </div>
          <div className="main-footer-content-dev">
            <img src="https://avatars3.githubusercontent.com/u/69821947?s=460&v=4" alt="Marcelo Borges" />
            <a href="https://github.com/dennerpl" target="_blank" rel="githubDenner">
          ...
          <div className="main-footer-content-dev">
            ...
            <a href="https://github.com/Marcelllombm" target="_blank" rel="githubMarcelo">
